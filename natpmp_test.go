...
func TestProtocolChecks(t *testing.T) {
	testCases := []addPortMappingRecord{
		...
		// Protocol version 2 (PCP).
		{
			"tcp", 123, 456, 1200,
			nil,
			fmt.Errorf("unknown protocol version 2 (server responded with PCP / Port Control Protocol)"),
			callRecord{
				[]uint8{0x0, 0x2, 0x0, 0x0, 0x0, 0x7b, 0x1, 0xc8, 0x0, 0x0, 0x4, 0xb0},
				[]uint8{0x2, 0x82, 0x0, 0x0, 0x0, 0x14, 0x4, 0x96, 0x0, 0x7b, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
				nil,
			},
		},
		// RFC 6886 result code 1: Unsupported Version (8-byte error response).
		{
			"tcp", 123, 456, 1200,
			nil,
			fmt.Errorf("Non-zero result code 1 (Unsupported Version)"),
			callRecord{
				[]uint8{0x0, 0x2, 0x0, 0x0, 0x0, 0x7b, 0x1, 0xc8, 0x0, 0x0, 0x4, 0xb0},
				[]uint8{0x0, 0x0, 0x0, 0x1, 0x0, 0x14, 0x4, 0x96},
				nil,
			},
		},
		// RFC 6886 result code 2: Not Authorized/Refused.
		{
			"tcp", 123, 456, 1200,
			nil,
			fmt.Errorf("Non-zero result code 2 (Not Authorized/Refused)"),
			callRecord{
				[]uint8{0x0, 0x2, 0x0, 0x0, 0x0, 0x7b, 0x1, 0xc8, 0x0, 0x0, 0x4, 0xb0},
				[]uint8{0x0, 0x82, 0x0, 0x2, 0x0, 0x14, 0x4, 0x96, 0x0, 0x7b, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
				nil,
			},
		},
		// RFC 6886 result code 3: Network Failure.
		{
			"tcp", 123, 456, 1200,
			nil,
			fmt.Errorf("Non-zero result code 3 (Network Failure (box has no DHCP lease or external IP))"),
			callRecord{
				[]uint8{0x0, 0x2, 0x0, 0x0, 0x0, 0x7b, 0x1, 0xc8, 0x0, 0x0, 0x4, 0xb0},
				[]uint8{0x0, 0x82, 0x0, 0x3, 0x0, 0x14, 0x4, 0x96, 0x0, 0x7b, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
				nil,
			},
		},
		// RFC 6886 result code 4: Out of resources.
		{
			"tcp", 123, 456, 1200,
			nil,
			fmt.Errorf("Non-zero result code 4 (Out of resources)"),
			callRecord{
				[]uint8{0x0, 0x2, 0x0, 0x0, 0x0, 0x7b, 0x1, 0xc8, 0x0, 0x0, 0x4, 0xb0},
				[]uint8{0x0, 0x82, 0x0, 0x4, 0x0, 0x14, 0x4, 0x96, 0x0, 0x7b, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
				nil,
			},
		},
		// RFC 6886 result code 5: Unsupported opcode.
		{
			"tcp", 123, 456, 1200,
			nil,
			fmt.Errorf("Non-zero result code 5 (Unsupported opcode)"),
			callRecord{
				[]uint8{0x0, 0x2, 0x0, 0x0, 0x0, 0x7b, 0x1, 0xc8, 0x0, 0x0, 0x4, 0xb0},
				[]uint8{0x0, 0x82, 0x0, 0x5, 0x0, 0x14, 0x4, 0x96, 0x0, 0x7b, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
				nil,
			},
		},
		// Unexpected result size with len >= 4.
		{
			"tcp", 123, 456, 1200,
			nil,
			fmt.Errorf("unexpected result size %d, expected %d", 10, 16),
			callRecord{
				[]uint8{0x0, 0x2, 0x0, 0x0, 0x0, 0x7b, 0x1, 0xc8, 0x0, 0x0, 0x4, 0xb0},
				[]uint8{0x0, 0x82, 0x0, 0x0, 0x0, 0x14, 0x4, 0x96, 0x0, 0x7b},
				nil,
			},
		},
	}
